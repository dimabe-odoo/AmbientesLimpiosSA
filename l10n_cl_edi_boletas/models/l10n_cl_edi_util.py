...
class L10nClEdiUtilMixin(models.AbstractModel):
    ...
    def _send_xml_to_sii_rest(self, mode, company_vat, file_name, xml_message, digital_signature):
        ...
        # The User-Agent parameter is mandatory. For now, it set as the same User-Agent used in the
        # documentation, using 'python-requests/2.21.0' or 'Odoo (http://www.odoo.com/contactus)' causes a
